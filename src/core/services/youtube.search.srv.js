/* @ngInject */
export default function YoutubeSearch ($http, YOUTUBE_API_KEY, YoutubeVideoInfo, YoutubePlaylistInfo, localStorageService, preset, toastr){
  ...
  function search (query, dontReset){
    ...
    _toast = toastr.info('', '<i class="fa fa-refresh fa-spin fa-3x"></i> Loading More...', {
